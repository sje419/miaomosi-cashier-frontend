<template>
    <unipopup ref="dialogRef" type="center" :maskClick="false">
        <view class="stock-dialog-wrap">
            ...
            <view class="btn">
                <button type="primary" class="primary-btn submit"  @click="submit('submit')">选中</button>
                <button type="primary" class="default-btn submit" @click="submit('close')">选中并关闭</button>
