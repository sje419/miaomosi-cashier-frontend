			...
			<view class="uni-flex uni-row">
				<view class="account-wrap">
					...
					<view class="account-item">
						...
						<view class="money">{{ globalStoreInfo.account | moneyFormat }}</view>
						<view class="action">
			...
			<view class="pop-box">
				...
				<view class="pop-content common-scrollbar" v-if="withdrawDetail">
					<view class="pop-content-item">
						...
						<view class="pop-contents-text" v-if="withdrawDetail.status == -1">拒绝理由：{{ withdrawDetail.refuse_reason }}</view>
